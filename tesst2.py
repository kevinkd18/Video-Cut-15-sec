...
async def process_video(video_path, message_id, part_duration=15):
    try:
        ...
        for i in range(num_parts):
            ...
            # Enhanced FFmpeg command for higher quality
            cmd = [
                ...
                '-x264-params', 'ref=6:me=umh:subq=9:trellis=2:8x8dct=1',
...
def complete_upload():
    ...
    asyncio.run_coroutine_threadsafe(process_video(video_path, int(time.time()), current_part_duration), bot_event_loop)
